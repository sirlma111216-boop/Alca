...
주소만 열면 설정 없이 바로 한 판 할 수 있습니다. 참가자 입력도, 발표자 선정도 없습니다.
난이도와 경기 시간만 고르면 시작합니다. 내 최고 기록은 **그 기기에만** 남습니다.

학생에게는 이 링크 하나만 주면 됩니다 — 열자마자 연습 화면입니다.

```
https://brickpick.sirlma.workers.dev/?practice=1
```

**경기 방식 두 가지**

- **자동 경기** — 참가자별로 독립된 경기장이 생기고 전부 동시에 진행됩니다.
  참가자는 조작하지 않고 관전합니다. 기본 30초(15/30/60초 선택). **"다 깰 때까지"** 를 고르면 누군가 벽돌을 전부 깨는 순간 끝납니다.
